...
export const ProfitabilityResultsSection: FC<ProfitabilityResultsSectionProps> = ({
  ...
  return (
    <BaseCard title="Предполагаемая выгода">
      ...
      <DescriptionText>
        Включает в себя: предполагаемую выгоду от дополнительных взносов («Премий»), увеличивающих стоимость Вашего права требования; членские взносы кооперативов за использование электронного документооборота платформы; а также единоразовую «Премию» «Исполнителя» за взнос трудом.
      </DescriptionText>
      <div className="disclaimer" style={{ marginTop: '16px', fontSize: '12px', background: 'rgba(223, 136, 64, 0.68)', padding: '12px', borderRadius: '8px' }}>
        <Text italic>
          Указанное значение годовой выгоды является предположительным и может изменяться как в большую так и в меньшую сторону в зависимости 
