...
export const ContributionResultsSection: FC<ContributionResultsSectionProps> = ({
  ...
  const pieLabels = [
    ...
    'Ваш взнос «Инвестора»',
    'Взнос «Авторов»',
    'Ваша «Прибавка» «Исполнителя»',
    '«Прибавка» «Авторов»',
    '«Прибавка» «Участников»',
    'Вклад других «Инвесторов»',
    'Взнос других «Создателей»',
    '«Прибавка» других «Создателей»'
  ];
      ...
      <Row gutter={[16, 16]}>
        <Col xs={24} lg={12} className='mt-md'>
          ...
          <div className="result-item">
            <Text>
              Ваша «Прибавка» «Исполнителя»:
              <SharedTooltip text="Дополнительная сумма, которую система начисляет Вам как «Создателю» «Результата» (100% от стоимости вашего «Результата» за вычетом выплаченной компенсации стоимости труда). «Прибавка» всегда капитализируется и увеличивает вашу долю в складочном капитале." />
            </Text>
          ...
          <div className="result-item">
            <Text>
              «Прибавка» «Ранние участники»:
              <SharedTooltip text="Дополнительная капитализация для «Ранние участники» («Авторов», «Исполнителей» и «Инвесторов»), рассчитанная по коэффициенту золотого сечения (161.8% от суммы стоимости и премий «Авторов» и «Исполнителей» за вычетом их возвратов). Эта «Прибавка» увеличивает общий складочный капитал и распределяется между всеми участниками согласно доле." />
            </Text>
          ...
          <div className="result-item">
            <Text>
              «Прибавка» других «Создателей»:
              <SharedTooltip text="Дополнительная сумма, начисляемая другим «Исполнителям» (100% от стоимости их «Результатов»). Эта «Прибавка» капитализируется в складочном капитале." />
            </Text>
